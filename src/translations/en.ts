...
export const en = {
    ...
    'page.body.landing.marketInfo.title.text1': 'Welcome to SNB Exchange.',
    ...
    'page.body.landing.register.item.text': 'SNB Exchange offers an intuitive interface with real time orderbooks, charting tools, trade history, and a simple order process so you can trade from day one.',
    'page.body.landing.register.item.button': 'register',

    'page.body.landing.features.title': 'SNB Exchange platform features',
    ...
    'page.body.landing.features.features.item1.text': 'SNB Exchange offers the most liquid order book in the world, allowing users to easily exchange Bitcoin, Ethereum, EOS, Litecoin, Ripple, NEO and many other digital assets with minimal slippage.',
    'page.body.landing.features.features.item2.text': 'SNB Exchange offers a suite of order types to give traders the tools they need for every scenario. Discover more about our most advanced Algorithmic orders types.',
    ...
    'page.body.landing.tradeOnTheGo.item.text3': 'All the power of SNB Exchange cryptocurrency exchange, in the palm of your hand.',
    ...
    'page.body.landing.footer.rights': 'SNB Exchange © All rights reserved.',
